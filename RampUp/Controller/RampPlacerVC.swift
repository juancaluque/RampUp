...
//  RampUp
//
//  Created by Juan Luque on 2/13/20.
...
class RampPlacerVC: UIViewController, ARSCNViewDelegate, UIPopoverPresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gesture1 = UILongPressGestureRecognizer(target: self, action: #selector(longPressed(_:)))
        let gesture2 = UILongPressGestureRecognizer(target: self, action: #selector(longPressed(_:)))
        let gesture3 = UILongPressGestureRecognizer(target: self, action: #selector(longPressed(_:)))
        
        gesture1.minimumPressDuration = 0.1
        gesture2.minimumPressDuration = 0.1
        gesture3.minimumPressDuration = 0.1
        rotateBtn.addGestureRecognizer(gesture1)
        downBtn.addGestureRecognizer(gesture2)
        upBtn.addGestureRecognizer(gesture3)
...
*/
    ...
    //MARK: @IBACTIONS
    @IBAction func rampWasPressed(_ sender: UIButton!) {
        let rampPickerVC = RampPickerVC(size: CGSize(width: 300, height: 550))
    ...
    @IBAction func removeWasPressed(_ sender: Any) {
    ...
    func rampSelected(_ name: String) {
